...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
        ...
        <br>
  <form class="form-horizontal" action="dummyallot.php" method='post'>
    
    
    <div class="form-group">        
      <div class="col-sm-offset-3 col-sm-6">
        <button type="submit" name="submit" class="btn btn-info btn-block">Start Round1 Counselling.</button>
...
if (mysqli_num_rows($result) > 0)
 {
  $w1= array(0,0);
        ...
        while($j<2)
        {
          ...
          $astring = implode("', '", $arrayOne);
            $astringTwo = "'".$astring."'";
               ...
               $query = "INSERT INTO round1 VALUES (".$astringTwo.")";
    ...
    echo "<script>alert('Round1 Conducted Successfully!')</script>";
}
 else {
    echo "0 results";
}
