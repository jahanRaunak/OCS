...
<div class="container-fluid text-center">    
  ...
  <form class="form-horizontal" action="upgrade.php" method='post'>
    ...
    <div class="form-group">
      ...
      <label class="control-label col-sm-3" for="upgrade"><br>Auto Upgradation :</label>
      <div class="col-sm-6">
    <br>
    <select class="form-control" id="upgrade" name="upgrade">
    ...
    <div class="form-group">        
     ...
     <h4><pre><center><strong>Note:</strong>The Last Value Of Auto-Upgradation Will Be Considered</center></pre></h4>
...
$at = $_SESSION['Rank'];
   ...
   if($result)
   {
       echo '<script>alert("Auto Upgradation Considered Successfully")</script>';
   }else{
   ...
   $query = "update round1 set Auto_upgrade='0' WHERE Rank='$at'";
   ...
   if($result)
   {
       echo '<script>alert("Auto Upgradation Deferred Successfully")</script>';
   }else{
       echo 'Data Not Updated';
   }
