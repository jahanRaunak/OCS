...
<img style="max-width:100px; margin-top: -7px;"
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="logout1.php" style="color:#b2dfdb"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
...
<form method='post' action="admin_login1.php">
    ...
    <div class="col-sm-offset-3 col-sm-6">
       ...
       <p><button type="submit" class="btn btn-info btn-block">Add Student Details</button></p>
  ...
  <form method='post' action="delete1.php">
    ...
    <div class="col-sm-offset-3 col-sm-6">
    <br>
       <p><button type="submit" class="btn btn-info btn-block">Delete Student Details</button></p>
  ...
  <form method='post' action="update1.php">
    ...
    <div class="col-sm-offset-3 col-sm-6">
    <br>
       <p><button type="submit" class="btn btn-info btn-block">Update Student Details</button></p>

      </div>
    </form>


    <form method='post' action="dummyallot.php">
    

       <div class="col-sm-offset-3 col-sm-6">
      <br>
       <p><button type="submit" class="btn btn-info btn-block">Start Round 1 Counselling</button></p>

      </div>
    </form>
    
    <form method='post' action="dummyallot2.php">
        <div class="col-sm-offset-3 col-sm-6">
    <br>
       <p><button type="submit" class="btn btn-info btn-block">Start Round 2 Counselling</button></p>

      </div>
    </form>

     <form method='post' action="dummyshow.php">

      <div class="col-sm-offset-3 col-sm-6">
    <br>
       <p><button type="submit" class="btn btn-info btn-block">Show Admitted Student</button></p>
