...
<div class="container-fluid text-center">    
  ...
  <form class="form-horizontal" action="admin_login.php" method='post'>
    <div class="form-group">
      <label class="control-label col-sm-3" for="User_Id">User_Id :</label>
      <div class="col-sm-6">
...
if (isset($_POST['submit'])){
  ...
  $admin_name=$_POST['User_Id'];
  $_SESSION["admin"]=$admin_name;
  $admin_pass = $_POST['pwd'];
 $check_email = "SELECT * FROM admin where pwd='$admin_pass' AND User_Id='$admin_name'";
